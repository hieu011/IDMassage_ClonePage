        ...
        <div className="col-span-2 flex flex-col text-[15px] gap-3">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2 flex-wrap">
                    <Button variant="outline" className="!text-xs !border-[var(--header-color-)]">THAILAND MASSAGE</Button>
                    <Button variant="outline" className="!text-xs">CẠO GIÓ KẾT HỢP VỚI XOA BÓP</Button>
                    <Button variant="outline" className="!text-xs">THUỶ ĐIẾN MASSAGE</Button>
                </div>
            </div>
            <div className="flex flex-col gap-2">
                <h2 className="text-sm font-[500] uppercase">Thời gian phục vụ</h2>
                <div className="flex gap-2 flex-wrap">
                    <Button variant="outline" className="!text-xs !border-[var(--header-color-)]">60 phút</Button>
                    <Button variant="outline" className="!text-xs">75 phút</Button>
                    <Button variant="outline" className="!text-xs">90 phút</Button>
                    <Button variant="outline" className="!text-xs">120 phút</Button>
                </div>
            </div>
            <div className="flex flex-col gap-2">
                <h2 className="text-sm font-[500] uppercase">Không gian yên tĩnh</h2>
                <div className="flex gap-2 flex-wrap">
                    <Button variant="outline" className="!text-xs">Yên lặng tuyệt đối - không làm phiền</Button>
                    <Button variant="outline" className="!text-xs !border-[var(--header-color-)]">Yên lặng bình thường - ít trao đổi</Button>
                    <Button variant="outline" className="!text-xs">Không gian sôi động</Button>
                </div>
            </div>
